   ...
   public function findAllProfils() {
    ...
    public function signin($login, $password) {
        $dql = "SELECT u.id uid, u.login as login, u.nomUtilisateur  as nomUtilisateur, u.status status, u.etatCompte etatCompte, 
                p.libelle as profil, p.description as description from Utilisateur\Utilisateur u JOIN u.profil p where u.login='$login' and u.password='$password' and u.status=1 ";
        try {
