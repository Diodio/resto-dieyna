...
namespace DoctrineORM\Proxies\__CG__\Employe;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Employe extends \Employe\Employe implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'reference', 'nom', 'adresse', 'contact', 'salaire', 'status', 'createdDate', 'updatedDate', 'deletedDate');
        }
    ...
    public function getSalaire()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSalaire', array());
    ...
    public function setSalaire($salaire)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSalaire', array($salaire));
