...
namespace DoctrineORM\Proxies\__CG__\Consommation;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Consommation extends \Consommation\Consommation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'libelle', 'date', 'quantite', 'article', 'produit', 'createdDate', 'updatedDate', 'deletedDate');
        }

        return array('__isInitialized__', 'id', 'libelle', 'date', 'quantite', 'article', 'produit');
    }
