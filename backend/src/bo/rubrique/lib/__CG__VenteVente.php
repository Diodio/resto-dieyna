 ...
 */
class Vente extends \Vente\Vente implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = array('date' => NULL, 'montant' => NULL, 'article' => NULL);
    ...
    {
        unset($this->date, $this->montant, $this->article);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'numero', 'date', 'montant', 'createdDate', 'updatedDate', 'deletedDate', 'article');
        }

        return array('__isInitialized__', 'id', 'numero', 'createdDate', 'updatedDate', 'deletedDate');
    }
