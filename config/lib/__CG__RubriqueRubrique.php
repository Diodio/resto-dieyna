 ...
 */
class Rubrique extends \Rubrique\Rubrique implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'code', 'libelle', 'status', 'login', 'createdDate', 'updatedDate', 'deletedDate');
        }
