...
namespace DoctrineORM\Proxies\__CG__\Approvisionnement;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Approvisionnement extends \Approvisionnement\Approvisionnement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'date', 'quantite', 'prixUnitaire', 'produit', 'createdDate', 'updatedDate', 'deletedDate');
        }

        return array('__isInitialized__', 'id', 'date', 'quantite', 'prixUnitaire', 'produit');
    }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Approvisionnement $proxy) {
