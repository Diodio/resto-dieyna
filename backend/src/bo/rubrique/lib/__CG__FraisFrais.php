...
namespace DoctrineORM\Proxies\__CG__\Frais;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Frais extends \Frais\Frais implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'date', 'libelle', 'prixUnitaire', 'quantite', 'status', 'createdDate', 'updatedDate', 'deletedDate');
        }
